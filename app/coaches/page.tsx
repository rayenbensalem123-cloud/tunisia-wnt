...
export default function CoachesPage() {
  ...
  return (
    <main className="ftf-portal min-h-screen p-8 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        {coaches.map((coach: any) => (
          <div key={coach.id} className="group relative">
            ...
            <div 
              className="relative w-full shadow-sm transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-3"
              style={{ 
